...
class DFCSEN12MSDataset:
    ...
    def get_patch(self, season, scene_id, patch_id, bands, window=None):
        ...
        #         if isinstance(warning.message, NotGeoreferencedWarning):
        #             print(f"Warning caught for file: {patch_path}")
    ...
    def get_s2_dfc(self, season, scene_id, patch_id, s2_bands=S2Bands.ALL, dfc_bands=LCBands.DFC, window=None):
